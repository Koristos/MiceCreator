...
const routes: Routes = [
  ...
  {path: "accommodation/new", component: AccommodationComponent},
  {path: "region_event/:id", component: RegionEventComponent},
  {path: "region_event/new", component: RegionEventComponent},
  {path: "hotel_event/:id", component: HotelEventComponent},
  {path: "hotel_event/new", component: HotelEventComponent},
